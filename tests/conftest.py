"""Pytest fixtures for sii module tests."""
import uuid
import pytest
...
@pytest.fixture
def sii_submission(db, hub_id):
    """Create a test SIISubmission."""
    return SIISubmission.objects.create(
        hub_id=hub_id,
        reference='Test Reference',
        submission_type='Test Submission Type',
        period='Test Period',
        status='Test Status',
        submitted_at=timezone.now(),
        response_code='TST-001',
    )
